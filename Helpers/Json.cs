...
namespace NavisworksReport
{
    public static class Json
    {
        ...
        public static string jsonFolderPath = $"{applicationPath}\\Nika_RD_Data\\Nika_RD_Json\\NavisworksReport";
        public static string jsonFilePath = $"{applicationPath}\\Nika_RD_Data\\Nika_RD_Json\\NavisworksReport\\NavisworksReport.json";
